...
import {  Orders, Calendar, Employees, Stacked, Pyramid, Customers, Kanban, Line, Area, Bar, Pie, Financial, ColorPicker, ColorMapping, Editor } from './';
import{ AIroutineMaker} from './AIroutineMaker'
          ...
          >
            ...
            <div>
              ...
              <Routes>
                ...
                <Route path="/syncfusionDashboard/employees" element={<Employees />} />
                <Route path="/syncfusionDashboard/customers" element={<Customers />} />
                <Route path="/syncfusionDashboard/airoutineMaker" element={<AIroutineMaker />} />

                {/* apps  */}
                <Route path="/syncfusionDashboard/kanban" element={<Kanban />} />
                <Route path="/syncfusionDashboard/editor" element={<Editor />} />
                <Route path="/syncfusionDashboard/color-picker" element={<ColorPicker />} />
                <Route path="/syncfusionDashboard/calendar" element={<Calendar />} />
